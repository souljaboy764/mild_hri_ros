...
while not rospy.is_shutdown():
	...
	elif len(trajectory) < 28:
		mu_q = np.deg2rad([31, -1, 74, 52])
	elif len(trajectory) < 36:
		mu_q = np.deg2rad([51, -1, 74, 52])
	elif len(trajectory) < 44:
		mu_q = np.deg2rad([31, -1, 74, 52])
	elif len(trajectory) < 52:
		mu_q = np.deg2rad([51, -1, 74, 52])
	elif len(trajectory) < 60:
		mu_q = np.deg2rad([31, -1, 74, 52])
	elif len(trajectory) < 68:
		mu_q = np.deg2rad([51, -1, 74, 52])
	else:
		break
